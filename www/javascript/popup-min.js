  ...
  return {
    // Basic options
    options:{
      'success':'<h4 style="margin-left: 56px;">Choose Version</h4><span><a href="https://iLabuhanbatu.moco.co.id/download/iLabuhanbatu_v1.5.0.dmg">&nbsp; &nbsp; Mac OS</a>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href="https://iLabuhanbatu.moco.co.id/download/iLabuhanbatuSetup_v1.5.0.exe">Windows OS</a> </span>',
      'error':'<a href="https://play.google.com/store/apps/details?id=mam.iLabuhanbatu.moco"><img src="images/store_badges.png" alt=""></a>'
    },
    // qS(class)
    qS: function(el) {
