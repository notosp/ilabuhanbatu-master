jQuery(window).load(function() {
	...
	document.getElementById('navIcon').src='images/mobile-navDOWN.png';
});
jQuery(document).ready(function() {
	...
	jQuery('.navigationButton').click(function() {
		if(jQuery('.navigationContent').is(':hidden')) {
			...
			document.getElementById('navIcon').src='images/mobile-nav.png';
		}
		else {
	...
	jQuery(".tombol").click(function () {
     ...
     jQuery(".pop > span, .pop").click(function () {
         jQuery(".pop").fadeOut(2300);
     });
